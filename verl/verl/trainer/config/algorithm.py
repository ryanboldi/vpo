...
class AlgoConfig(BaseConfig):
    ...
    # max@k (https://arxiv.org/abs/2510.23393) subset size for the rank-weighted
    # advantage. None => default max(2, rollout.n // 2). Must satisfy 1 <= k <= n-1.
    max_at_k_k: Optional[int] = None
