"""Thin CLI shim — the ToolRL eval lives in tasks/tool.py (TASK.evaluate).

Usage: python eval/eval_tool.py --model <merged_hf_path> --method vpo --n-chains 17 --num-solutions 3
"""
